...
export function DetailsSection() {
  return (
    <section
      ...
      className="relative w-full overflow-hidden bg-gradient-to-b from-blush via-sand to-cream px-6 py-28 sm:py-36"
    >
        ...
        {weddingDetails.map((detail, index) => {
          ...
          return (
            <SectionReveal
              key={detail.label}
              delay={index * 0.12}
              className="flex flex-col items-center gap-5 rounded-sm border border-terracotta/20 bg-pearl/80 px-8 py-12 text-center shadow-[0_25px_50px_-30px_rgba(58,42,32,0.3)]"
            >
